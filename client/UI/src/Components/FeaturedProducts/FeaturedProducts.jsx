...
const FeaturedProducts = ({type}) => {
  ...
  return (
    <div className='featuredProducts'>
      <div className="top">
        <h1>{type} products</h1>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi fugiat dolorum,
             nesciunt cupiditate possimus aut nihil nam reiciendis impedit consectetur voluptate, 
             eius porro dolor et earum rem ea. Eaque vero architecto 
            natus dicta nesciunt, tempore exercitationem tenetur! Accusantium, voluptatibus quasi.</p>
      </div>
